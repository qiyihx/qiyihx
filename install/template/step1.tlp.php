...
<div class="main">
	<div class="sidebar">
		<div class="logo" title="phpWeChat <?php echo PHPWECHAT_VERSION.PHPWECHAT_RELEASE;?> 安装向导"><a href="https://qiyihx.cn/" target="_blank"></a></div>
		<div class="step">
			<ul class="current">
		...
		<div class="bg_center">
			<div class="bg_left">
				<div class="bg_right">
					...
					　　有关本软件最终用户授权协议、商业授权与技术服务的详细内容，均由phpWeChat( <a href="https://qiyihx.cn/" target="_blank">https://qiyihx.cn/</a> )和官方论坛( <a href="http://bbs.qiyihx.com/" target="_blank">http://bbs.qiyihx.com/</a> )提供唯一的解释和官方价目表。phpWeChat拥有在不提前通知的情况下，修改授权协议和价目表的权力，修改后的协议或价目表对自改变之日起的新授权用户生效。<br />
					<br /> 
